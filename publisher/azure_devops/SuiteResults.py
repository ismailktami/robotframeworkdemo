...
class SuiteResults(ResultVisitor):
    ...
    def get_testcases_id_status(self, suite):
        ...
        self.suites.append({'name':suite.name,'id':suiteId,'planId':testplanId,'tests_ids_status':tests_ids_status,'tests_witout_ids':tests_witout_ids,'testcases':testcases,'starttime':suite.starttime,'endtime':suite.endtime})
